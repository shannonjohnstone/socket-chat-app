      ...
      <section>
        ...
        <div className="l-container">
          ...
          <div className="grid-example">
            <div className="row">
              <div className="col col-sm-12 col-med-6 col-lrg-4"></div>
              <div className="col col-sm-12 col-med-6 col-lrg-4"></div>
              <div className="col col-sm-12 col-med-6 col-lrg-4"></div>
            </div>
            <div className="row">
              <div className="col col-sm-12 col-lrg-3"></div>
              <div className="col col-sm-12 col-lrg-3"></div>
              <div className="col col-sm-12 col-lrg-6"></div>
            </div>
            <div className="row">
          ...
          <div className="grid-example">
            <div className="row">
              <div className="col col-sm-12 col-med-6 col-offset-sm-12 col-offset-med-3"></div>
            </div>
            <div className="row">
              <div className="col col-sm-12 col-med-3"></div>
              <div className="col col-sm-12 col-med-3 col-offset-sm-12 col-offset-med-6"></div>
            </div>
            <div className="row">
              <div className="col col-sm-12 col-med-3 col-offset-sm-12 col-offset-med-3"></div>
              <div className="col col-sm-12 col-med-3"></div>
            </div>
          </div>
        </div>
